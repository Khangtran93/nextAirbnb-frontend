  ...
  return (
    <div className='mt-4 max-w-[1200px] mx-auto'>
      ...
      <div className='flex flex-row justify-between'>
        <div>
          <p className='text-xl font-semibold'>{dataProperty.title}</p>
        </div>
      ...
      <div className='grid grid-cols-6 w-full h-[120vh] mt-4 relative'>
        ...
        <div className='col-span-4'>
          ...
          <div className='flex flex-row w-4/5 p-2 border-2 mt-2 px-4 rounded-lg justify-between items-center'>
            ...
            <div className='items-center cursor-pointer text-lg font-semibold text-center'>
              <p>103</p>
              <div className='opacity-90 text-xs underline font-normal'>
                Reviews
              </div>
            </div>
          ...
          <div className='w-4/5 border-b-2'>
            <div className='flex flex-row gap-4 py-4 items-center'>
              <div className='w-[48px] items-center'>
              ...
              <div>
                ...
                <p className='opacity-60'>A room with Wi-Fi that is well suited for working.</p>
              </div>  
            ...
            <div className='flex flex-row gap-4 py-4 items-center'>
              ...
              <div>
                ...
                <p className='opacity-60'>You can check-in with the building staff.</p>
              </div> 
            </div>
            ...
            <div className='flex flex-row gap-4 py-4 items-center'>
              ...
              <div>
                <p className="font-semibold">{dataProperty.landlord.name} is a Superhost.</p>
                <p className='opacity-60'>Superhosts are experienced, highly rated Hosts.</p>
              </div> 
            </div>
          </div>
